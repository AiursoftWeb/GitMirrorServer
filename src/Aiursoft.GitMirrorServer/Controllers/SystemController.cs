...
using Aiursoft.GitMirrorServer.Models.SystemViewModels;
...
[Authorize]
[LimitPerMin]
public class SystemController(ILogger<SystemController> logger, GitMirrorServerDbContext dbContext) : Controller
{
